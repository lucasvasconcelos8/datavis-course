function Network() {
  ...
  //funcao para mostrar o tamanho do no proporcional ao numero de arestas conectadas
  function mapNodeRadius(data){
    var map = {}
  ...
  function setupData(data) {
    ...
    var nodeRadius = mapNodeRadius(data)
    ...
    data.nodes.forEach(function(n) {
      ...
      //nova variavel para indicar a quantidade de arestas conectadas
      n.nodeRadius = nodeRadius[n.id]
      // add radius to the node so we can use it later
      n.radius = circleRadius(nodeRadius[n.id]);
    });
  ...
  function showDetails(d, i) {
    ...
    content += '<p class="main">' + d.nodeRadius + '</span></p>';
